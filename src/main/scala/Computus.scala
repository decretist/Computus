...
class Computus extends HttpServlet {
  override def doGet(request: HttpServletRequest, response: HttpServletResponse) = {
    ...
    response.getWriter().print(literalDoGet)
  }

  override def doPost(request: HttpServletRequest, response: HttpServletResponse) = {
    val startDate = request.getParameter("startDate").toInt
    val endDate = request.getParameter("endDate").toInt
    val literalDoPost =
      <html>
        <head>
    ...
    response.getWriter().print(literalDoPost)
  }
